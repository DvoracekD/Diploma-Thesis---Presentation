...
\begin{frame}{Motivation}
    \begin{itemize}
        \item \textbf{Information Overload:} Vast amounts of news and text overwhelm manual analysis.
        \item \textbf{Unstructured Summaries:} Traditional methods do not produce machine-usable outputs.
        \item \textbf{Structured Extraction Needed:} Identify and link key entities, events, and time relations.
        \item \textbf{Supports Automation:} Enables automated timelines, search, and analytical tasks.
        \item \textbf{NLP Advances:} LLMs offer improvements, but structured multi-document summarization is still challenging.
    \end{itemize}
\end{frame}
%------------------------------------------------
...
\begin{itemize}
    \item Custom evaluation pipeline: Precision, Recall, F1 for entities, events and their assignments
    \item Entity matching using fuzzy string similarity
...
\begin{frame}{Evaluation Dataset}
    \begin{itemize}
        ...
        \item Total of 348 entities
        \item Total of 406 events
    \end{itemize}
\end{frame}
%------------------------------------------------
...
\begin{itemize}
    ...
    \item Custom evaluation shows progress across pipeline versions
\end{itemize}
...
\textbf{Conclusion}:
\begin{itemize}
    \item Introduced a reproducible, modular extraction pipeline for multi-document structured summarization
